...
import { Chart as ChartJS, CategoryScale,  LinearScale,  RadialLinearScale,  PointElement,  LineElement,  ArcElement,  Title,  Tooltip,  Legend,  Filler,
} from "chart.js";
import { Line, Radar } from "react-chartjs-2";

ChartJS.register( CategoryScale, LinearScale,  RadialLinearScale,  PointElement,  LineElement,  ArcElement,  Title,
  Tooltip,
  Legend,
  Filler
);
...
const Dashboard = () => {
  ...
  const pcCounts = safeLabs.map(
    (lab) => safePcs.filter((pc) => pc.labId === lab.id).length
  );
  ...
  const isLoading =
    safeLabs.length === 0 && safePcs.length === 0 && safeStudents.length === 0;
